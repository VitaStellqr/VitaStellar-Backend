        ...
        return (
          <svg {...baseProps}>
            <circle
              ...
              cy="60"
              r="50"
              fill="var(--empty-state-bg, #fef3e2)"
            />
            <rect
              x="35"
              y="30"
            ...
            <rect
              ...
              height="8"
              rx="4"
              fill="var(--empty-state-muted, #d4a574)"
            />
            <rect
              x="35"
              y="60"
        ...
        <button
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.backgroundColor =
              'var(--empty-state-button-hover, #cc7a00)';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.backgroundColor =
              'var(--empty-state-button-bg, #e68a00)';
          }}
          onFocus={(e) => {
            e.currentTarget.style.outline =
              '2px solid var(--empty-state-focus, #e68a00)';
